...
const FloatingWhatsApp = ({ phoneNumber = "+1234567890", message = "Hello! I'm interested in your crackers." }) => {
  ...
  return (
    <div className="fixed left-4 top-1/2 transform -translate-y-1/2 z-50">
      <button
        ...
        className="bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group"
